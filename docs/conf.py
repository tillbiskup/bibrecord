...
# defined by theme itself.  Builtin themes are using these code by
...
latex_documents = [
    (master_doc, 'bibrecord.tex', 'bibrecord Documentation',
     'Till Biskup', 'manual'),
]
...
man_pages = [
    (master_doc, 'bibrecord', 'bibrecord Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bibrecord', 'bibrecord Documentation',
     author, 'bibrecord', 'Handling bib(tex) records for references',
     'Miscellaneous'),
]
